...
import com.challenge.challenge.filter.JwtAuthenticationFilter;
import com.challenge.challenge.filter.JwtAuthorizationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authenticationManager) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/v1/spotify/authorize").permitAll()
                        .requestMatchers("/api/v1/spotify/oauth2/callback/spotify").permitAll()
